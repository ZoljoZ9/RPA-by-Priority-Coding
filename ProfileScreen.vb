...
Partial Class ProfileScreen
    ...
    Private WithEvents sideMainControl As SideMain
    ...
    Public Sub New()
        ...
        ' Add the SideMain user control to the SplitContainer1.Panel1
        SplitContainer1.Panel1.Controls.Add(sideMainControl)
        sideMainControl.Dock = DockStyle.Fill ' Dock the user control to fill the container
    ...
    Private Sub InitializeEventHandlers()
        ...
        InitializeScrapeFileButton() ' Call method to initialize scrapeFileButton

        ' Initialize scrapeWebsiteButton
        scrapeWebsiteButton = New Button()
        InitializeScrapeWebsiteButton() ' Call method to initialize scrapeWebsiteButton

        ' Add scrapeFileButton and scrapeWebsiteButton to Panel2
        Me.SplitContainer1.Panel2.Controls.Add(scrapeFileButton)
        Me.SplitContainer1.Panel2.Controls.Add(scrapeWebsiteButton)

        ' Add event handler to the scrape file button click event
    ...
    Private Sub ScrapeInfo_Click(sender As Object, e As EventArgs) Handles ScrapeInfo.Click
        ...
        ' Toggle the visibility of the scrapeFileButton based on Dude selection
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentResourceManager = New ComponentResourceManager(GetType(ProfileScreen))
        SplitContainer1 = New SplitContainer()
        ScrapeInfo = New Button()
        ...
        SplitContainer1.Panel1.Controls.Add(ScrapeInfo)
        ' 
        ' SplitContainer1.Panel2
        ' 
        SplitContainer1.Panel2.BackColor = Color.FromArgb(CByte(51), CByte(51), CByte(51))
        SplitContainer1.Size = New Size(537, 346)
        SplitContainer1.SplitterDistance = 152
        SplitContainer1.TabIndex = 0
        ' 
        ' Button1
        ' 
        ScrapeInfo.Location = New Point(12, 24)
        ScrapeInfo.Name = "ScrapeInfo"
        ScrapeInfo.Size = New Size(114, 50)
        ScrapeInfo.TabIndex = 0
        ScrapeInfo.Text = "Scrape Informaation"
        ScrapeInfo.UseVisualStyleBackColor = True
        ' 
        ' ProfileScreen
        ' 
    ...
    Private Sub ProfileScreen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Create an instance of the SideMain form
        sideMainControl = New SideMain()

        ' Call the method to initialize dynamic controls on the instance
        sideMainControl.InitializeDynamicControls()

        ' Add the sideMainControl to your form
        sideMainControl.Dock = DockStyle.Fill
        SplitContainer1.Panel1.Controls.Add(sideMainControl)
    End Sub

    Friend WithEvents ScrapeInfo As Button
End Class
