...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' Calculate vertical offset for controls
        Dim verticalOffset As Integer = 250

        ' Calculate horizontal offset for buttons
        Dim buttonWidth As Integer = 107
        Dim horizontalOffset As Integer = (Me.ClientSize.Width - (2 * buttonWidth + 10)) / 2

        ' Adjust control positions
        logoLogin.Location = New Point((Me.ClientSize.Width - logoLogin.Width) / 2, 20)
        emailLogin.Location = New Point((Me.ClientSize.Width - emailLogin.Width) / 2, verticalOffset)
        passwordLogin.Location = New Point((Me.ClientSize.Width - passwordLogin.Width) / 2, verticalOffset + 30)
        loginLogin.Location = New Point(horizontalOffset, verticalOffset + 60)
        loginLogin.Size = registerLogin.Size
        registerLogin.Location = New Point(horizontalOffset + buttonWidth + 10, verticalOffset + 60)
